...
if not isfolder("saturn") then
    makefolder("saturn")
end

if not isfolder("saturn/configs") then
    makefolder("saturn/configs")
end

if not isfolder("saturn/configs/da_hood") then
    makefolder("saturn/configs/da_hood")
end
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("saturn [ grave ]")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("saturn/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("saturn/configs/da_hood") do
            ...
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("saturn.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
